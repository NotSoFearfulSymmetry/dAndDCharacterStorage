...
INSERT INTO user (user_id, username, password, email) VALUES (1, 'ElfLord', 'testPassword1', 'WoodElvesAreBestElves@juno.com');
INSERT INTO user (user_id, username, password, email) VALUES (2, 'RogueOneThird', 'testPassword2', 'backstabber123@hotmail.com');
INSERT INTO user (user_id, username, password, email) VALUES (3, 'iamthedragon42', 'testPassword3', 'burninator@hsr.com');

INSERT INTO `character` (id, name, race, gender, class_and_level, strength, dexterity, constitution, intelligence, wisdom, charisma, hit_points, skills, feats, class_features, equipment, description, background, second_user_access, second_username, user_id) VALUES (1, 'George Longshanks', 'human', 'male', 'Fighter 9', 15, 11, 13, 8, 6, 8, 57, 'Skills', 'Feats', 'Class Features', 'Equipment', 'Description', 'Background', FALSE, NULL, 1);
